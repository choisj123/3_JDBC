...
public class CreateXMLFile {
	public static void main(String[] args) {
		...
		// XML에 저장되는 데이터 형식은 Map <Key:Value>
		// Map<String, String>
		...
		try {
			...
			// FileOutputStream 생성
			// 파일명.xml
			FileOutputStream fos = new FileOutputStream(fileName + ".xml"); //FileNotFoundException
			
			// Properties 객체를 이용해 XML 파일 생성
			prop.storeToXML(fos, fileName + ".xml"); // IOException
